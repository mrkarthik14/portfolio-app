...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const getOffsets = (evt: MouseEvent | PointerEvent | React.MouseEvent | React.PointerEvent, el: HTMLElement): Offset => {
    ...
    useEffect(() => {
        ...
        // Cast events to any to avoid strict type checks for custom event triggers
                    ...
                    <div className="pc-inside">
                        ...
                        <div className="pc-content">
                            <div className="pc-details">
                                <h3 style={{ fontSize: '1.5rem', marginTop: '10px' }}>{name}</h3>
